...
(function() {
  var Axis, Q, QC, QCircuitGrid, QCircuit_black_dot, QCircuit_component, QCircuit_gate, QCircuit_line, QCircuit_multigate, QCircuit_qswap, QCircuit_target, QCircuit_white_dot, QueueEvent, X, Y, center, cols, dashed_box, draw, drawer, get_cur_rel_pos, line_preview, locate_mouse, mk_table, rows, sz_cfg, update_dashed_box;
  ...
  QueueEvent = (function() {
    ...
    QueueEvent.prototype.length = function() {
  ...
  update_dashed_box = function(x1, y1, x2, y2) {
    ...
    for (i = _j = 0; _j < 4; i = ++_j) {
      _results.push(dashed_box[i].attr({
        'stroke': 'black',
  ...
  drawer.mousemove(function(event) {
    var Bx, By, color, x, x1, x2, y, y1, y2, _ref, _ref1, _ref2, _ref3;
    ...
    if (Q.func && Q.func.type === 'line_preview') {
      if (Q.length() === 1) {
        _ref2 = center(Q.Q[0][0], Q.Q[0][1]), x1 = _ref2[0], y1 = _ref2[1];
        _ref3 = center(Bx, By), x2 = _ref3[0], y2 = _ref3[1];
        if (line_preview) {
          line_preview.remove();
        }
  ...
  window.add_black_dot = function() {
    ...
    func.test = function(x1, y1, x2, y2) {
      return y1 === y2;
    };
